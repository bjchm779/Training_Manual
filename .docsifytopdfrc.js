module.exports = {
    ...
    pathToPublic: "imgenius trainingmanual.pdf", // path where pdf will stored
    pdfOptions: {
        displayHeaderFooter: true,
        format: 'A4',
        printBackground: true,
        headerTemplate: '<div class="header" style="font-size: 15px;color: #000; margin: 10px auto;clear:both; position: relative;"><span>imgenius 培训手册</span></div>',
